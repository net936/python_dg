...
class Thing(models.Model):
    ...
    cailiao = models.CharField(max_length=50, blank=True, null=True) # 材料
    chicun = models.CharField(max_length=10, blank=True, null=True) # 尺寸
    guige = models.CharField(max_length=50, blank=True, null=True) # 规格
    zhongliang = models.CharField(max_length=50, blank=True, null=True) # 重量
    status = models.CharField(max_length=1, choices=STATUS_CHOICES, default='0')
    create_time = models.DateTimeField(auto_now_add=True, null=True)
