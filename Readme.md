...
>该项目是基于Python+Vue开发的蛋糕商城管理系统（前后端分离），这是一项为大学生课程设计作业而开发的项目。
该系统旨在帮助大学生学习并掌握Python编程技能，同时锻炼他们的项目设计与开发能力。通过学习基于Python的蛋糕商城管理系统项目，大学生可以在实践中学习和提升自己的能力，为以后的职业发展打下坚实基础。学习过程中遇到问题可以咨询微信：Lengqin1024 或者发Email: kefu308@gmail.com



## 在线演示

演示地址：[https://dg.gitapp.cn](https://dg.gitapp.cn)


## 源码下载

https://github.com/geeeeeeeek/python_dg


## 主要功能

- 蛋糕管理：管理系统可以录入、修改和查询蛋糕的基本信息，如名称、价格、备注等。
